...
from src.model.paligemma.utils import JointKVCache, apply_rotary_pos_emb, repeat_kv
...
class JointModel(nn.Module):
    ...
    def forward(
        ...
        # [Batch_Size, Seq_Len, Hidden_Size]
        return hidden_states, action_hidden_states
...
if __name__ == "__main__":
    ...
    causal_mask = torch.full(
        (total_len, total_len), float("-inf"), dtype=torch.float32
    )  # neg inf
    causal_mask[
